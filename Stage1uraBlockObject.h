...
public:
	static Stage1uraBlockObject* Create(int window_width, int window_height);//インスタンス生成とinitialize呼び出し
	...
	//コンストラクタ
	Stage1uraBlockObject() = default;
	//仮想デストラクタ
	virtual ~Stage1uraBlockObject();
	//初期化
...
protected:
	...
	XMMATRIX matWorld;
	//親オブジェクト
	Stage1uraBlockObject* parent = nullptr;
	Object3d* parent2 = nullptr;
