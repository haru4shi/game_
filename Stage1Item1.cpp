...
ID3D12Device* Stage1Item1::device = nullptr;
ID3D12GraphicsCommandList* Stage1Item1::cmdList = nullptr;
ComPtr<ID3D12RootSignature> Stage1Item1::rootsignature;
ComPtr<ID3D12PipelineState> Stage1Item1::pipelinestate;


void Stage1Item1::StaticInitialize(ID3D12Device* device)
{
	Stage1Item1::device = device;
}

void Stage1Item1::InitializeGraphicsPipeline()
{
	HRESULT result;
...
void Stage1Item1::InitializeDescriptorHeap()
{
	HRESULT result;
...
void Stage1Item1::InitializeCamera(int window_width, int window_height)
{
	// ビュー行列の生成
...
Stage1Item1* Stage1Item1::Create(int window_width, int window_height)
{
	// 3Dオブジェクトのインスタンスを生成
	Stage1Item1* stage1Item1 = new Stage1Item1();
...
void Stage1Item1::Initialize(int window_width, int window_height)
{
	// デスクリプタヒープの初期化
...
void Stage1Item1::PreDraw(ID3D12GraphicsCommandList* cmdList)
{
	// コマンドリストをセット
	Stage1Item1::cmdList = cmdList;
...
void Stage1Item1::SetCollider(BaseCollider* collider)
{
...
void Stage1Item1::PostDraw()
{
	Stage1Item1::cmdList = nullptr;
}

void Stage1Item1::LoadMaterial(const std::string& directoryPath, const std::string& filename)
{
	//ファイルストリーム
	ifstream file;
	//マテリアルファイルを開く
...
bool Stage1Item1::LoadTexture(const std::string& directoryPath, const std::string& filename)
{
